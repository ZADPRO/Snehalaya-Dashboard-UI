  ...
  const fetchSuppliers = async () => {
    try {
      const resp = await axios.get(
        `${import.meta.env.VITE_API_URL}/admin/suppliers/read`,
        {
          headers: {
  ...
  return (
    <div className="card">
      ...
      >
        ...
        <Column field="supplierIsActive" header="Active" body={row => row.supplierIsActive === 'true' || row.supplierIsActive === true ? 'Yes' : 'No'} sortable />
